...
const double g = 9.8, k = 1e4, Gamma = 5e2, kcundall = 1e308, MU = 0.4, surfTension=27.5e-3;//surfTension es el gamma de la fuerza capilar
...
void InicieAnimacion(void){
  ...
  std::cout<<"set output 'capi_2307_27.5.gif'"<<std::endl;
